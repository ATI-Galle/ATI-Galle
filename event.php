...
<div class="container1">
  <div class="main-content">
    ...
    <div class="image-album">
      <img src="img/slider/s-1.jpg" alt="Thumb 1" class="thumb" onclick="changeMainImage(this)">
      <img src="img/slider/s-2.jpg" alt="Thumb 2" class="thumb" onclick="changeMainImage(this)">
      <img src="img/slider/s-3.jpg" alt="Thumb 3" class="thumb" onclick="changeMainImage(this)">
      <img src="img/slider/s-4.jpg" alt="Thumb 4" class="thumb" onclick="changeMainImage(this)">
      <img src="img/slider/s-5.jpg" alt="Thumb 5" class="thumb" onclick="changeMainImage(this)">
      <img src="img/slider/s-6.jpg" alt="Thumb 6" class="thumb" onclick="changeMainImage(this)">
      <img src="img/slider/s-7.jpg" alt="Thumb 7" class="thumb" onclick="changeMainImage(this)">
      <img src="img/slider/s-8.jpg" alt="Thumb 8" class="thumb" onclick="changeMainImage(this)">
    </div>
