...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="container mx-auto px-4 py-8 md:py-16">
                    ...
                    <div class="w-full md:w-2/3">
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-600 leading-relaxed">
                                I am a final-year HNDIT student at SLIATE with a passion for building intuitive, performant, and user-centric web applications. This website was developed as part of my First Year project, aiming to create a modern digital portal for our university community.
                            </p>
                        </div>
        ...
        <footer class="text-center mt-16">
            ...
            <a href="mailto:vihangamanodhya1@gmail.com" class="mt-4 inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transition-transform hover:scale-105">
                Get in Touch
            </a>
        </footer>
