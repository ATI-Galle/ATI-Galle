...
if ($selected_cid !== null) {
    ...
    if ($course_data) {
        ...
        if ($stmt_all_modules) {
            ...
            foreach ($modules_data_by_year_sem as $year => &$semesters) { ksort($semesters); }
        }
                    ...
                    <div class="content-section">
                        ...
                        <?php if ($hod): ?>
                            ...
                            <div class="hod-profile">
                                <img src="<?php echo 'admin/'.htmlspecialchars($hod['stimg']); ?>" alt="Photo of <?php echo htmlspecialchars($hod['sname']); ?>">
                            ...
                            <div class="staff-grid">
                                <?php foreach ($other_staff as $staff): ?>
                                    <div class="staff-card">
                                        <img src="<?php echo 'admin/'.htmlspecialchars($staff['stimg']); ?>" alt="Photo of <?php echo htmlspecialchars($staff['sname']); ?>">
