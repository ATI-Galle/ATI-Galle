...
/* NEW: If you want to completely hide scrollbar but keep scrolling functionality */
/* Be aware: this makes it not obvious that there's more content */
/*
.dropdown-menu::-webkit-scrollbar {
    display: none; // Completely hides the scrollbar for webkit
}
.dropdown-menu {
    -ms-overflow-style: none;  // IE and Edge
    scrollbar-width: none;  // Firefox
...
<body>
    ...
    <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="max-height: 400px; overflow-y: auto; font-size: 10px;">
        ...
        <?php
        // Ensure your courses table has 'Course_ID' and 'Course_Name' columns
        ...
        <?php } ?>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="index.php#event">Events</a>
                                    </li>
                                    <li class="nav-item">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Make sure to include Bootstrap's JS for dropdowns to work
            // If it's not already in your footer, you might need:
